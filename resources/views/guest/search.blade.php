@extends('layouts.guest', ['title' => 'Search Results'])
@section('css')
...
@section('content')
    <div class="category-main">
        {{-- all items cards html --}}
        <div class="category-name">Search Results for "{{ $search }}"</div>
        <div class="row  py-3 ruby-row" style="border-bottom: 0">
            <div class="category-name mt-3">Items</div>
                        ...
                        <a href="{{ route('products.show', $product->id) }}" class="products-card-link">
                            <div class="card-body">
                                <div class="card-body-first">
                                    <h5 class="m-0 p-2 text-center text-truncate text-capitalize">{{ $product->weight }} ct
                                        {{ $product->name }} </h5>
                                </div>
                            </div>
                        </a>
                        ...
                        <div class="card-footer ">
                            <div class="footer-icons-part d-flex align-items-center  justify-content-start ps-3  gap-1">
                                ...
                                @else
                                    ...
                                    <button class="m-0 p-0 border-0 bg-transparent" type="button" title="Add to cart"
                                ...
                                @endif
                                <button class="m-0 p-0 rounded-4 border-0 bg-transparent" title="Certified">
            ...
            <div class="products-cards grid_system_rectangle">
                @forelse ($categories as $category)
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="card-body-first">
                                <h5 class="m-0 p-2 text-center text-truncate">{{ strtoupper($category->name) }}</h5>
                            </div>
                            <div class="card-body-second">
                                <a href="{{ route('categories.products', $category->id) }}">View</a>
                            </div>
                        </div>
                    </div>
                @empty
        ...
        {{-- all stores cards html --}}
        <div class="row">
            <div class="category-name">Stores</div>
            <div class="products-cards grid_system_rectangle">
                @forelse ($stores as $store)
                    <div class="card">
                        <img src="{{ asset($store->image ?? 'assets/home/stones.jpg') }}" class="card-img-top"
                            style="height: 50% !important;
                        width: 100% !important;
                        max-width: 100%;
                        object-fit: cover !important;"
                        ...
                        <div class="card-body">
                            <div class="card-body-first">
                                <h5 class="m-0 p-2 text-center text-truncate">{{ strtoupper($store->name) }}</h5>
                            </div>
                            <div class="card-body-second">
