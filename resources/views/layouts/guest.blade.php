...
<body>
                            ...
                            <li>
                                <div class="">
                                    <span class="icon-link user-options-selector"
                                        style="cursor: pointer">{{ auth()->user()->name }} <i
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 fill p-2">
                        <ul class="categories-list  m-0 p-0">
                            <li class="categories ps-2 my-2">Categories</li>
                            <!-- All Categories Link -->
                            <li class="">
                                <a href="/categories" class="main-item">
                                    View All Categories
                                </a>
                            </li>
                            @php
                                // Get All Categories with Products and products count greater than 0
                                $categories = \App\Models\Category::withCount('products')->having('products_count', '>', 0)->get();
                            @endphp
    ...
    {{-- <script>
        ...
        var splideArrows = document.querySelectorAll('.splide__arrow');
        window.addEventListener('load', function() {
            ...
            splideArrows.forEach((splideArrow) => {
                splideArrow.classList.add('splide__arrow--hidden');
            })
        })
    </script> --}}
</body>
