<!-- guest and buyer header options -->
...
<div class="col-md-8  login-register position-relative pe-2">
    <ul class="">
        ...
        @auth
            ...
            @if (auth()->user()->hasRole('buyer'))
                <li>
                    <div class="">
                        <span class="icon-link stores-selector scheme-text-color scheme-active"
                            style="cursor: pointer">Stores
                            <i class="bi bi-chevron-down  scheme-text-color" style="font-size: 12px"></i>
                        </span>
                    </div>
                </li>
                <li>
                    <div class="">
                        <span class="icon-link no-reserve-selector scheme-text-color scheme-active"
                            style="cursor: pointer">No
                            Reserve <i class="bi bi-chevron-down  scheme-text-color" style="font-size: 12px"></i>
                        </span>
                    </div>
                </li>
            @endif
    ...
    <!-- for stores details -->
    <div class="stores-list bg-white  all-flex-center position-absolute menu-control shadom-sm">
        <ul class=" all-flex-center flex-column py-4 m-0" style="width:100%;height:auto;">
            <li class="w-100">
                <a class="user-option-item" href="{{ route('stores') }}">All Stores
                </a>
            </li>
        </ul>
    </div>

    <!-- for no reserve stores details -->
    <div class="no-reserve-list bg-white  all-flex-center position-absolute menu-control shadom-sm">
        <ul class=" all-flex-center flex-column py-4 m-0" style="width:100%;height:auto;">
            <li class="w-100">
                <a class="user-option-item" href="{{ route('auctions.no-reserve') }}">No Reserve Gemstones
                </a>
            </li>
        </ul>
    </div>
