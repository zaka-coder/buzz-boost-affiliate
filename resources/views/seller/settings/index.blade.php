@extends('layouts.seller', ['title' => 'Seller Settings'])
@section('css')
    ...
    <div class="bids-main-container w-100 h-100">
        ...
        <div class="w-100 h-auto h-md-15">
            ...
            <div class="w-100 h-auto h-md-100 d-flex flex-md-row flex-column align-items-md-start align-items-center gap-2">
                ...
                {{-- <a href="/sellerShipping" class="anchor-button rounded-2 ">Shipping Address</a>
        ...
        <div class="w-100 h-auto h-md-85 p-4" style="background-color: #FFF; overflow:auto">
            {{-- member details --}}
            <form action="{{ route('seller.settings.update.profile') }}" method="post" class="mb-4">
                @csrf
                @method('put')
                <div class="row w-100 my-2">
                    <h1 class="fs-5 fw-bold">Seller Details</h1>
