@extends('layouts.seller', ['title' => 'Support'])
@section('css')
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
            <div class="modal-content p-3  position-relative">
                ...
                <div class="modal-body p-0 m-0 w-100" style="border: none">
                    <form action="{{ route('support.store', ['role' => 'seller']) }}" method="post">
                        @csrf
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
                <div class="modal-content p-3  position-relative">
                    ...
                    <div class="modal-body p-0 m-0 w-100" style="border: none">
                        ...
                        @endforeach
                        <form
                            action="{{ route('support.reply.store', ['role' => 'seller', 'parent_id' => $support->id]) }}"
