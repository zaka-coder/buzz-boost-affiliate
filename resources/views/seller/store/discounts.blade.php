                    ...
                    <div class="row mt-3">
                        <div class="col-lg-12 col-12">
                            ...
                            <div class="d-flex align-items-center gap-2 mt-3">
                                <input type="checkbox" name="" id="asking_offer"><label for="asking_offer"
                                    style="font-size: 14px">Send me an email
                                    every time an offer is made on my items</label>
                            </div>
                            <div class="d-flex align-items-center gap-2 mt-3">
                                <input type="checkbox" name="" id="asking_email_sold"><label for="asking_email_sold"
                                    style="font-size: 14px">Send me an email
                                    every time one of my item is sold</label>
                            </div>
                            <div class="mt-3">
                                <div class="d-flex align-items-center gap-2 mt-3">
                                    <input type="checkbox" name="" id="asking_payment"><label for="asking_payment"
                                        style="font-size: 14px">Send me an email
                                        every time i receive Payment</label>
                                </div>
                            </div>
                            <div class="my-5">
                                <button class="anchor-button text-white rounded-2 border-0"
