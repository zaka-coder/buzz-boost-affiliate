...
@section('content')
    ...
    <div class="bids-main-container w-100 h-100">
        ...
        <div class="w-100 h-auto h-md-50">
            <!-- Filter options for bid status -->
            <div
                class="w-100 h-auto bg-dangera h-md-20 d-flex flex-md-row flex-column align-items-md-start align-items-center gap-2">
                ...
                <a href="sales-awaiting" class="anchor-button rounded-2 active">Awaiting Shipments</a>
                <a href="/sales-paid" class="anchor-button rounded-2">Paid & Shipped</a>
            </div>
            <!-- Sorting options section -->
            <div class="w-100 h-20 bg-warninga d-flex rounded-2" style="background-color:#105082">
                <h3 class="p-0 m-0 w-60  h-100 d-flex align-items-center justify-content-start ms-3"
                    style="font-size:17px;color:white;">7 Buyers awaiting Shippments</h3>
            ...
            <!-- Sorting options section -->
            <div class="w-100 h-20 bg-infoa  d-flex rounded-2 my-2" style="background-color:#E1E1E1">
                <h3 class="p-0 m-0 w-60  h-100 d-flex align-items-center justify-content-start ms-3 text-dark"
                    style="font-size:17px;color:white;"><i class="bi bi-person-fill"></i>&nbsp;&nbsp;<span>Zaka Ullah</span>
                </h3>
                <!-- Sorting dropdown with label -->
                <div class="w-40 h-100" style="">
                    <div class="ms-auto  me-2 py-1" style="width:fit-content">
                        <!-- Dropdown menu for sorting -->
                        <button class="anchor-button rounded-3" id="action-awaiting-button"
                            style="background: #105082;color:white;">Action</button>
                        <table class="rounded-2 position-relative py-2" id="action-awaiting-table"
                            style="width: 170px;height:auto;background-color:#105082;display:none;z-index:2">
                            <tr>
                                <td class="ps-2 text-white">
                                    <button type="button" class="bg-transparent border-0 text-white" data-bs-toggle="modal"
                                        data-bs-target="#postal-address">Postal Address</button>
                                </td>
                            </tr>
                            <tr>
                                <td class="ps-2 text-white">cancel</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="ps-2 text-white">block</td>
                            </tr>
                            <tr>
                                <td class="ps-2 text-white">View Purchases</td>
                            </tr>
                        </table>
                    </div>
                </div>
            ...
            <!-- Sorting options section -->
            <div class="w-100 h-40 bg-primarya  d-flex rounded-2 " style="background-color:#FFF">
                <h3 class="p-0 m-0 w-50  h-100 d-flex align-items-center justify-content-start ms-3 text-dark"
                    style="font-size:17px;color:white;"><span>Invoice #12131215</span>
                </h3>
                <!-- Sorting dropdown with label -->
                <div class="w-50 h-100  d-flex align-items-center justify-content-center" style="">
                    <div class="">
                        <button class="anchor-button rounded-2 text-dark" style="background-color:#E1E1E1">Payment
                            Info</button>
                        <button class="anchor-button rounded-2" style="background: #105082;color:white">Mark as
                            Shipped</button>
                    </div>
                </div>
            </div>
        ...
        <div id="bids-container" class="w-100 h-50   p-1" style="background-color: #FFF; overflow:auto">
            ...
            <div class="bids-card w-100 m-auto d-flex flex-md-row flex-column align-items-center my-3 shadow-none">
                ...
                <div class="w-100 w-md-25 h-100 d-flex align-items-center justify-content-center position-relative">
                    <button class="anchor-button rounded-3 m-auto d-block" id="update-sales-awaiting-button"
                        style="background: #105082;color:white;width:120px!important">Action</button>
                    <table class="rounded-2 position-absolute py-2" id="update-sales-awaiting-table"
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-md">
                <div class="modal-content p-3">
                    ...
                    <div class="modal-body p-0 m-0 w-100 d-flex align-items-start flex-column flex-md-row  m-0"
                        ...
                        <div class="postal-address-right b w-50  mt-3">
                            <div>
...
@section('js')
    <script>
        var actionAwaitingButton = document.getElementById('action-awaiting-button');
        var actionAwaitingTable = document.getElementById('action-awaiting-table');

        actionAwaitingButton.addEventListener('click', function() {
            if (actionAwaitingTable.style.display === 'none') {
                actionAwaitingTable.style.display = 'block';
            } else {
                actionAwaitingTable.style.display = 'none';
            }
        });
        var updateSalesAwaitingButton = document.getElementById('update-sales-awaiting-button');
        var updateSalesAwaitingTable = document.getElementById('update-sales-awaiting-table');

        updateSalesAwaitingButton.addEventListener('click', function() {
            if (updateSalesAwaitingTable.style.display === 'none') {
                updateSalesAwaitingTable.style.display = 'block';
            } else {
                updateSalesAwaitingTable.style.display = 'none';
            }
        });
    </script>
@endsection
